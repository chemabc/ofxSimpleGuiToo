...
public:
	...
	ofxSimpleGuiTitle			&addTitle(string name="", bool bSuperTitle=false, float height = 0);
	...
	ofxSimpleGuiInputText		&addInputText(string name, string &variable, string defaultValue="");
